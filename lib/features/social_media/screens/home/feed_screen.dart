...
import 'package:social_media_app/features/social_media/screens/home/create_post.dart';
                  ...
                  children: [
                    IconButton(
                      icon: _isLiked
                          ...
                          : Icon(Iconsax.heart),
                      onPressed: () {
                        _likePost(widget.post
                            .id); // Call _likePost function with the post id
                      },
                    ),
                    Text(
