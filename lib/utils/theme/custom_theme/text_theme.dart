...
class SMATextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    bodyLarge: const TextStyle().copyWith(fontSize: 14.8, fontWeight: FontWeight.w500, color: Colors.black),
    ...
    labelMedium: const TextStyle().copyWith (fontSize: 12.8, fontWeight: FontWeight.normal, color: Colors.black.withOpacity(0.5)),
  );
  static TextTheme dartTextTheme = TextTheme(
    ...
    bodyMedium: const TextStyle().copyWith(fontSize: 14.8, fontWeight: FontWeight.normal, color: Colors.white),
    ...
    labelMedium: const TextStyle().copyWith(fontSize: 12.8, fontWeight: FontWeight.normal, color: Colors.white. withOpacity(0.5)),
  );
}